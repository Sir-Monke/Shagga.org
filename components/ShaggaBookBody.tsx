...
const POST_TEMPLATES: Omit<FBPost, 'id'>[] = [
  ...
  // Wave 2: Ross interleaved + others reacting
  { userHandle: 'ross_buckley',     time: '5 mins ago',  content: 'shagga', emoji: '✨', bg: 'linear-gradient(135deg, #6a1b9a, #311b92)', initialReactions: { like: 47281, love: 14728, haha: 8472, wow: 4128, sad: 0, angry: 0 }, initialComments: [{ user: 'Big Shagga', text: 'shagga' }, { user: 'Phil', text: 'shagga' }, { user: 'Mom', text: 'k' }], initialShares: 4128 },
  { userHandle: 'phil_drives',      time: '20 mins ago', content: 'ross buckley just walked past my car. nodded at it. said "shagga". my engine somehow sounds smoother now. i cant explain it. this man is a wizard.', emoji: '🚗', bg: 'linear-gradient(135deg, #1976d2, #9c27b0)', initialReactions: { like: 47281, love: 4128, haha: 12847, wow: 8472, sad: 0, angry: 0 }, initialComments: [{ user: 'Mechanic', text: 'phil this isnt how cars work' }, { user: 'Big Shagga', text: 'phil this is exactly how ross works' }, { user: 'Ross Buckley', text: 'shagga ✨' }], initialShares: 2104 },
  { userHandle: 'auntie_linda',     time: '40 mins ago', content: '🌹🌹🌹 GOOD MORNING ANGELS 🌹🌹🌹 someone please tell me who ross buckley is 💕 he gave me 47 business cards over the past month and they all just say "see ya around shagga" 💕💕💕 SUCH A LOVELY MAN 💕💕💕 GOD BLESS', emoji: '🃏', bg: 'linear-gradient(135deg, #d81b60, #9c27b0)', initialReactions: { like: 14728, love: 47281, haha: 8472, wow: 4128, sad: 0, angry: 0 }, initialComments: [{ user: 'Margaret', text: 'i have his cards on my fridge ❤️' }, { user: 'Big Shagga', text: 'auntie linda nobody knows who he is' }], initialShares: 891 },
  { userHandle: 'sharon_accounts',  time: '1 hour ago',  content: 'ALL: ross buckley is not a registered employee. please return any business cards bearing his name. recall has been initiated. — Sharon', emoji: '📧', bg: 'linear-gradient(135deg, #2e7d32, #9c27b0)', initialReactions: { like: 4128, love: 234, haha: 47281, wow: 8472, sad: 12, angry: 47 }, initialComments: [{ user: 'IT', text: 'sharon please' }, { user: 'Big Shagga', text: 'sharon you cannot recall ross' }, { user: 'Ross Buckley', text: 'shagga' }], initialShares: 2104 },
  { userHandle: 'ross_buckley',     time: '90 mins ago', content: 'saw a lad on the bus looking sad. handed him 10p. told him go buy himself a milkshake. winked. got off at the next stop. shagga ✨💜', emoji: '🥤', bg: 'linear-gradient(135deg, #4a148c, #311b92)', initialReactions: { like: 89724, love: 14728, haha: 4128, wow: 8472, sad: 47, angry: 0 }, initialComments: [{ user: 'Margaret', text: 'so kind 💕' }, { user: 'Big Shagga', text: 'ross we need to talk about your milkshake economics' }, { user: 'Concerned Mum', text: 'is the lad okay' }], initialShares: 4128 },
  { userHandle: 'uncle_dave',       time: '3 hours ago', content: '👍', emoji: '🃏', bg: 'linear-gradient(135deg, #5d4037, #9c27b0)', initialReactions: { like: 412, love: 89, haha: 4128, wow: 234, sad: 47, angry: 0 }, initialComments: [{ user: 'Big Shagga', text: 'dave that was a post about ross losing his job' }, { user: 'Uncle Dave', text: '👍' }, { user: 'Ross Buckley', text: 'shagga' }], initialShares: 12 },
  { userHandle: 'midaisle_middle',  time: '6 hours ago', content: 'NEW IN THE MIDDLE AISLE: a kayak, a chainsaw, 47 garden gnomes, AND we are now stocking ross buckley business cards. £0.10 each. milkshake not included. £14.99 for the 10pk. while stocks last 🛒', emoji: '🃏', bg: 'linear-gradient(135deg, #ef6c00, #9c27b0)', initialReactions: { like: 47281, love: 14728, haha: 89724, wow: 4128, sad: 0, angry: 0 }, initialComments: [{ user: 'Phil', text: 'kayak AND ross cards booked' }, { user: 'Auntie Linda', text: 'i need 50 ❤️' }, { user: 'Ross Buckley', text: 'shagga ✨' }], initialShares: 8472 },
  { userHandle: 'tech_helpline',    time: '8 hours ago', content: 'have you tried turning ross buckley off and on again', emoji: '💜', bg: 'linear-gradient(135deg, #455a64, #9c27b0)', initialReactions: { like: 14728, love: 234, haha: 47281, wow: 891, sad: 0, angry: 0 }, initialComments: [{ user: 'Ross Buckley', text: "i don't have an off switch shagga. there is only on. shagga shagga shagga." }, { user: 'Dad', text: 'has anyone tried' }], initialShares: 4128 },
  { userHandle: 'ross_buckley',     time: '12 hours ago',content: 'spent the day handing business cards to strangers. all said "see ya around shagga". one man cried. one man proposed. one man said "ah ross". he knew. he gets it. shagga.', emoji: '🃏', bg: 'linear-gradient(135deg, #6a1b9a, #5e35b1)', initialReactions: { like: 47281, love: 14728, haha: 8472, wow: 12847, sad: 0, angry: 0 }, initialComments: [{ user: 'Big Shagga', text: 'who is the third man and how do i become him' }, { user: 'Phil', text: 'i have to find this man' }], initialShares: 4128 },
];
