...
const INITIAL_SHWEETS: Shweet[] = [
  ...
  // === Wave 2: Ross interleaved through the timeline (fresh timestamps so they scatter to top) ===
  { id: 41, authorHandle: 'ross_buckley',  text: "shagga",                                                                                                           ageMin: 1,    initialLikes: 12847,  initialReposts: 2104,  initialReplies: 412 },
  { id: 42, authorHandle: 'phil_drives',   text: "ross buckley just walked past my car. nodded at it. said 'shagga'. somehow my engine sounds smoother now. cant explain it",   ageMin: 3,    initialLikes: 47281,  initialReposts: 8472,  initialReplies: 1247 },
  { id: 43, authorHandle: 'big_shagga_94', text: "found another ross buckley business card in my pocket. that's 14 now. i did not see him put any of them there",                ageMin: 8,    initialLikes: 89724,  initialReposts: 14728, initialReplies: 4128 },
  { id: 44, authorHandle: 'ross_buckley',  text: "saw a lad on the bus looking sad. handed him 10p. told him to go buy himself a milkshake. winked. got off at the next stop. shagga ✨", ageMin: 15,   initialLikes: 47281,  initialReposts: 12847, initialReplies: 8472 },
  { id: 45, authorHandle: 'sharon_from_acc', text: "ALL: ross buckley is not a real employee. please disregard the business cards. — Sharon",                                  ageMin: 18,   initialLikes: 14728,  initialReposts: 4128,  initialReplies: 891 },
  { id: 46, authorHandle: 'big_shagga_94', text: "sharon you can't disregard ross. nobody can. ross is everywhere. i taped one of his cards to my mirror and i sleep better now",   ageMin: 22,   initialLikes: 47281,  initialReposts: 8472,  initialReplies: 2104, parentId: 45 },
  { id: 47, authorHandle: 'ross_buckley',  text: "thongs arrived. 10pk. silk. lavender. me + the lads are buzzing. spots still available. shagga 💜",                          ageMin: 35,   initialLikes: 89724,  initialReposts: 14728, initialReplies: 12047 },
  { id: 48, authorHandle: 'concerned_mum', text: "what are thongs",                                                                                                          ageMin: 38,   initialLikes: 47281,  initialReposts: 8472,  initialReplies: 4128, parentId: 47 },
  { id: 49, authorHandle: 'ross_buckley',  text: "shagga",                                                                                                                  ageMin: 40,   initialLikes: 14728,  initialReposts: 2104,  initialReplies: 891, parentId: 48 },
  { id: 50, authorHandle: 'concerned_mum', text: "k",                                                                                                                       ageMin: 41,   initialLikes: 89724,  initialReposts: 14728, initialReplies: 8472, parentId: 49 },
  { id: 51, authorHandle: 'doreen_57',     text: "this lovely young man ross popped round for a brew yesterday. didn't say much. left a card. it just said 'see ya around shagga'. i've put it on the fridge ❤️", ageMin: 65,   initialLikes: 14728,  initialReposts: 4128,  initialReplies: 891 },
  { id: 52, authorHandle: 'tech_helpline', text: "have you tried turning ross buckley off and on again",                                                                  ageMin: 110,  initialLikes: 47281,  initialReposts: 8472,  initialReplies: 1247 },
  { id: 53, authorHandle: 'ross_buckley',  text: "i don't have an off switch shagga. there is only on. shagga shagga shagga.",                                            ageMin: 125,  initialLikes: 89724,  initialReposts: 14728, initialReplies: 4128, parentId: 52 },
  { id: 54, authorHandle: 'ranga_tim',     text: "ross buckley taught me how to wink properly today. i practised in the mirror for 3 hours. i can now wink. life-changing. shagga.", ageMin: 280,  initialLikes: 14728,  initialReposts: 2104,  initialReplies: 412 },
  { id: 55, authorHandle: 'shaggacouncil', text: "BREAKING: the council has voted unanimously to make 'shagga' the official greeting in honour of ross buckley. effective immediately.",  ageMin: 340,  initialLikes: 47281,  initialReposts: 12847, initialReplies: 4128 },
  { id: 56, authorHandle: 'ross_buckley',  text: "honoured. truly. see ya around shagga ✨",                                                                                ageMin: 350,  initialLikes: 89724,  initialReposts: 14728, initialReplies: 8472, parentId: 55 },
  { id: 57, authorHandle: 'big_shagga_94', text: "asked ross buckley what his job is. he handed me a business card. it just said 'see ya around shagga'. so it's that. his job is that.", ageMin: 600,  initialLikes: 47281,  initialReposts: 8472,  initialReplies: 1247 },
  { id: 58, authorHandle: 'shaggas_mate',  text: "ross buckley sent me a christmas card in may. it just said 'see ya around shagga'. no signature. no greeting. no envelope. just appeared on my desk", ageMin: 1200, initialLikes: 14728,  initialReposts: 4128,  initialReplies: 891 },
  { id: 59, authorHandle: 'midaisle_middle', text: "this week in the middle aisle: a kayak, a chainsaw, 47 garden gnomes, AND we're now stocking ross buckley business cards (£0.10 each, milkshake not included)", ageMin: 1500, initialLikes: 89724, initialReposts: 14728, initialReplies: 4128 },
  { id: 60, authorHandle: 'ross_buckley',  text: "saw a man buy a sausage roll at greggs. picked it up after he dropped it. handed it back. winked. he proposed to me. politely declined. shagga ✨",  ageMin: 1800, initialLikes: 47281,  initialReposts: 12847, initialReplies: 8472 },
  { id: 61, authorHandle: 'margaret_90',   text: "ross popped over to help me find my phone. didn't find it. left a business card. very lovely young man. love nan x",         ageMin: 2400, initialLikes: 14728,  initialReposts: 4128,  initialReplies: 891 },
];
