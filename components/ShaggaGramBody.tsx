...
const POST_TEMPLATES: Omit<Post, 'id'>[] = [
  ...
  { userHandle: 'ross_buckley',     bg: 'linear-gradient(135deg, #5e35b1, #311b92)', emoji: '🃏', caption: "business cards just dropped. front: see ya around shagga. back: nothing. they are working perfectly.", initialLikes: 14728, initialComments: [{ user: '@big_shagga_94', text: 'why did u give me 47 of these' }, { user: '@phil_drives', text: 'i taped one to my dashboard' }] },

  // Other characters reacting to Ross + Ross interleaved through feed
  { userHandle: 'big_shagga_94',    bg: 'linear-gradient(135deg, #9c27b0, #4a148c)', emoji: '🃏', caption: "found another ross buckley business card in my pocket. that's 14. 14 cards. i did not see him put any of them there. how is he doing this", initialLikes: 47281, initialComments: [{ user: '@phil_drives', text: 'i found 9 in my glovebox' }, { user: '@auntie_linda', text: 'such a lovely young man 🌹💕' }, { user: '@shazza_official', text: 'i hung mine on the wall' }] },
  { userHandle: 'ross_buckley',     bg: 'linear-gradient(135deg, #6a1b9a, #311b92)', emoji: '✨', caption: "shagga", initialLikes: 89724, initialComments: [{ user: '@big_shagga_94', text: 'shagga' }, { user: '@shazza_official', text: 'shagga' }, { user: '@tradielife', text: 'shagga' }, { user: '@nan', text: 'lovely 🌹' }] },
  { userHandle: 'shazza_official',  bg: 'linear-gradient(135deg, #d81b60, #9c27b0)', emoji: '💄', caption: "ross buckley winked at me at the chippy and i swear my mascara fixed itself. queen behaviour. shagga 💜", initialLikes: 14728, initialComments: [{ user: '@goon_lord_3000', text: 'unbeatable energy' }, { user: '@ross_buckley', text: 'shagga ✨' }] },
  { userHandle: 'cooked_dave',      bg: 'linear-gradient(135deg, #00838f, #5e35b1)', emoji: '🃏', caption: "ross buckley turned up at the dam. didn't swim. didn't talk. left a business card on a rock. it said 'see ya around shagga'. the rock has been more profitable than my actual job since.", initialLikes: 8472, initialComments: [{ user: '@big_shagga_94', text: 'the rock now charges rent' }] },
  { userHandle: 'ross_buckley',     bg: 'linear-gradient(135deg, #4a148c, #311b92)', emoji: '🥤', caption: "saw a lad on the bus looking sad. handed him 10p. told him to go buy himself a milkshake. winked. got off at the next stop. shagga ✨💜", initialLikes: 47281, initialComments: [{ user: '@concerned_mum', text: 'is he ok' }, { user: '@big_shagga_94', text: 'ross is fine ross is always fine' }, { user: '@auntie_linda', text: 'BLESS U ROSS 💕' }] },
  { userHandle: 'goon_lord_3000',   bg: 'linear-gradient(135deg, #c4006c, #6a1b9a)', emoji: '🍷', caption: "ross buckley showed up at goon of fortune. didn't drink. didn't peg. just said 'shagga' three times and left. we won every round after. is he a good luck charm. is he a god.", initialLikes: 4128, initialComments: [{ user: '@shazza_official', text: 'absolutely a god' }, { user: '@ross_buckley', text: 'shagga' }] },
  { userHandle: 'tradielife',       bg: 'linear-gradient(135deg, #5d4037, #6a1b9a)', emoji: '🛠️', caption: "on smoko. ross buckley walked past. handed me a business card. now my drill works again. it has been broken since 2019. shagga.", initialLikes: 1247, initialComments: [{ user: '@boss', text: 'come back to work' }, { user: '@cookwithshagga', text: 'ross fixed my pan once' }] },
  { userHandle: 'ross_buckley',     bg: 'linear-gradient(135deg, #ad1457, #4a148c)', emoji: '🩲', caption: "thong update: 10pk arrived. silk. lavender. me + the lads buzzing. spots still available. shagga 💜✨", initialLikes: 14728, initialComments: [{ user: '@cooked_dave', text: 'address?' }, { user: '@tradielife', text: 'in' }, { user: '@big_shagga_94', text: 'ross plz' }] },
  { userHandle: 'cookwithshagga',   bg: 'linear-gradient(135deg, #ffa500, #9c27b0)', emoji: '🍳', caption: "fried egg attempt #48. ross buckley walked past the kitchen. winked at the pan. it has now achieved perfection. i am quitting. ross does the cooking from now on", initialLikes: 891, initialComments: [{ user: '@nan', text: 'lovely lad ❤️' }, { user: '@ross_buckley', text: 'shagga' }] },
  { userHandle: 'shaggas_nan',      bg: 'linear-gradient(135deg, #ec407a, #9c27b0)', emoji: '🌹', caption: "such a lovely young man ross popped round for a brew. didn't say much. left me a business card. it just says 'see ya around shagga'. i've put it on the fridge ❤️ love nan x", initialLikes: 47281, initialComments: [{ user: '@big_shagga_94', text: 'nan everyone has these cards' }, { user: '@auntie_linda', text: 'i have 12 on my fridge 💕' }] },
];
