...
const CHANNELS: Channel[] = [
  ...
  { id: 'bunntv',  name: 'BunningsTV',     handle: '@bunningstv',   subs: '892k', emoji: '🔨', color: '#f00' },
...
const VIDEOS: Video[] = [
  ...
  { id: 2,  title: 'how to put a snag on a sandwich (CORRECT WAY)',                      channelId: 'bunntv',  views: 892_000,   ageDays: 14,   durationSec: 862,   thumbBg: 'linear-gradient(135deg, #f00 0%, #ff8c00 100%)',   emoji: '🌭', description: 'the definitive guide. onions UNDER. settled science. dispute me.', tags: ['food', 'tutorial'] },
  { id: 3,  title: 'I lived in a Bunnings for 24 hours (NOT clickbait!!)',                channelId: 'topsh',   views: 2_100_000, ageDays: 30,   durationSec: 1391,  thumbBg: 'linear-gradient(135deg, #00a86b 0%, #0066cc 100%)', emoji: '🔨', description: 'security found me at hour 23. worth it. one star.', tags: ['vlog', 'challenge'] },
  ...
  { id: 12, title: 'BREAKING: shagga seen at bunnings (FOOTAGE)',                         channelId: 'outback', views: 247_000,   ageDays: 2,    durationSec: 142,   thumbBg: 'linear-gradient(135deg, #c40 0%, #802 100%)',       emoji: '🚨', description: 'witnesses say he was holding what appeared to be a snag.', tags: ['breaking'] },
  { id: 13, title: 'I tried to cook with only Bunnings ingredients',                      channelId: 'cooks',   views: 412_000,   ageDays: 18,   durationSec: 1102,  thumbBg: 'linear-gradient(135deg, #ffa500 0%, #f00 100%)',    emoji: '🍳', description: 'turns out the snags from the sausage sizzle slap.', tags: ['food', 'challenge'] },
  ...
  { id: 20, title: 'I followed a Bunnings sausage sizzle queue for 8 hours',              channelId: 'topsh',   views: 412_000,   ageDays: 11,   durationSec: 28800, thumbBg: 'linear-gradient(135deg, #f00 0%, #ffa500 100%)',    emoji: '🌭', description: 'the queue is a microcosm of society.', tags: ['vlog', 'documentary'] },
];
