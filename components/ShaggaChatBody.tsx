...
const SCRIPT: { handle: string; text: string }[] = [
  ...
  { handle: 'BigShagga_NYC',  text: 'wait who let ross in' },
  { handle: 'TopShaggaUK',    text: 'nobody lets ross in. ross simply IS in.' },
  ...
  { handle: 'BigShagga_NYC',  text: 'wait i found a business card on my desk' },
  { handle: 'BigShagga_NYC',  text: 'it just says "see ya around shagga". how' },
  { handle: 'sydney_shagga',  text: 'thats just ross. dont overthink it' },
  ...
  { handle: 'ross_buckley',   text: 'shagga ✨' },
  { handle: 'ShaggaParis',    text: 'ross thinks cereal is a soup' },
  { handle: 'ross_buckley',   text: 'shagga' },
  { handle: 'ross_buckley',   text: 'left chat' },
  ...
  { handle: 'BigShagga_NYC',  text: 'has anyone else been getting ross buckley business cards in their pockets' },
  { handle: 'TopShaggaUK',    text: 'i have 47' },
  { handle: 'ShaggaParis',    text: 'i have 12. one was in my fridge somehow' },
  { handle: 'shagga_tokyo',   text: 'i found one in my passport' },
  { handle: 'sydney_shagga',  text: 'one fell out of my wallet at the bus stop and a stranger picked it up and said "ah ross"' },
  { handle: 'BigShaggaBR',    text: 'literally how is he doing this' },
  { handle: 'TopShaggaUK',    text: 'global shagga council secret. classified.' },
  ...
  { handle: 'ross_buckley',   text: 'shagga' },
  { handle: 'ShaggaParis',    text: 'ross texts back with "shagga" within 0.4 seconds. unbeatable.' },
  { handle: 'ross_buckley',   text: 'left chat' },
  ...
  { handle: 'sydney_shagga',  text: 'a milkshake u bought with the 10p ross gave u' },
  { handle: 'TopShaggaUK',    text: 'oh thats just objectively correct' },
